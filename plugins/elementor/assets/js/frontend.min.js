    ...
    7248: (e, t, n) => {
      ...
      e.exports = function (e) {
        ...
        const addElementsHandlers = () => {
          ...
          addHandlerWithHook = (e, t, n = "default") => {
            ...
            elementorFrontend.hooks.addAction(
              `frontend/element_ready/${r}`,
              (e) => {
                if (isClassHandler(t))
                  this.addHandler(t, { $element: e, elementName: r }, !0);
                else {
                  const n = t();
                  if (!n) return;
                  n instanceof Promise
                    ...
                    : this.addHandler(n, { $element: e, elementName: r }, !0);
                }
              },
            );
          };
        (this.addHandler = function (n, r) {
          ...
          const i = new n(r);
          elementorFrontend.hooks.doAction(
            `frontend/element_handler_ready/${r.elementName}`,
            r.$element,
            e,
          ),
            o && (t[o][s] = i);
