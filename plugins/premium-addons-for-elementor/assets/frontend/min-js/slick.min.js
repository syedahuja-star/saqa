  ...
  ((n.fn.animate = function (e, i, t, o) {
    ...
    return (
      ...
      this.each(function () {
        this[r] || (this[r] = l++);
        var i = n.extend({}, s);
        (d.apply(n(this), [e, n.extend({}, i)]),
          (a[this[r]] = { run: !0, prop: e, opt: i, start: c(), done: 0 }));
      })
    );
  }),
    (n.fn.pause = function () {
    ...
    (n.fn.resume = function () {
      return this.each(function () {
        ...
        i &&
          !i.run &&
          ((i.opt.duration -= i.done),
          (i.done = 0),
          (i.run = !0),
          (i.start = c()),
          d.apply(n(this), [i.prop, n.extend({}, i.opt)]));
      });
    }));
})(),
  (function (i) {
    ...
    ((s = 0),
      ((r = function (i, e) {
        ...
        ((o.defaults = {
          ...
          (o.freezeAnimation = a.proxy(o.freezeAnimation, o)),
          (o.resumeAnimation = a.proxy(o.resumeAnimation, o)),
          (o.instanceUid = s++),
          (o.htmlExpr = /^(?:\s*(<[\w\W]+>)[^>]*)$/),
      ...
      (r.prototype.animateSlide = function (i, e) {
        ...
        if (
          ...
          (!0 === o.options.variableWidth &&
            ...
            (s =
              o.options.speed *
              a(o.$slides.get(o.currentSlide - 1)).data("slick-width-factor")),
            (o.myAnimation = o.$slideTrack
              .prop({ animStart: o.currentLeft })
              .animate(
                { animStart: i },
                {
                  duration: s,
      ...
      (r.prototype.buildDots = function () {
        ...
        if (!0 === t.options.dots && t.slideCount > t.options.slidesToShow) {
          for (
            ...
            e.append(
              a("<li />").append(t.options.customPaging.call(this, t, i)),
            );
        ...
        if (
          (i.$slides.each(function (i, e) {
            (a(e)
              ...
              t.push(a(e).outerWidth()));
          }),
          !0 === i.options.variableWidth && !1 === i.options.vertical)
        ) {
          var o = Math.max.apply(null, t);
          i.$slides.each(function (i, e) {
            a(e).attr("data-slick-width-factor", t[i] / o);
          });
        }
      ...
      (r.prototype.freezeAnimation = function () {
        this.myAnimation && this.paused && this.myAnimation.pause();
      }),
      (r.prototype.resumeAnimation = function () {
        this.myAnimation && !this.paused && this.myAnimation.resume();
      }),
      ...
      a(".jet-listing-grid__slider").length < 1 &&
        (a.fn.slick = function () {
          var i,
            e,
            t = this,
