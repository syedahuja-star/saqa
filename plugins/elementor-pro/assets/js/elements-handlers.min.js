        ...
        getQueryStringInObjectForm() {
          ...
          for (const t in this.loopWidgetsStore.get()) {
            ...
            for (const o in n.consolidatedFilters) {
              ...
              for (const n in s) {
                const o =
                  l.queryConstants[s[n].logicalJoin ?? "AND"].separator.decoded;
      ...
      class _default extends elementorModules.frontend.Document {
        ...
        handleKeyboardA11y() {
          this.keyboardHandler ||
            (this.keyboardHandler = new l.default(
          ...
          this.getModal = () => {
            if (!e) {
              ...
              elementorFrontend.config.experimentalFeatures.e_font_icon_svg &&
                (s.closeButtonOptions = { iconElement: i.close.element }),
